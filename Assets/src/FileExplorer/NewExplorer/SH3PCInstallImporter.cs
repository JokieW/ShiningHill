    ...
    public override void ImportSource()
    {
        try
        {
            ...
            //Copy data
            {
                ...
                if (ExplorerUtil.DirectoryCopy(from, to, true, (s, f) => EditorUtility.DisplayCancelableProgressBar("Importing files...", s, f))) return;
            }
            ...
            //Make arcarc proxy
            {
                SH3ArcArcImportProxy arcarc = CreateInstance<SH3ArcArcImportProxy>();
