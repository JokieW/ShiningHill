...
{
    [CustomEditor(typeof(SH3PS3InstallImporter))]
    public class SH3PS3InstallImporterEditor : Editor
    {
    ...
    [CreateAssetMenu(fileName = "SH3PS3InstallImporter", menuName = "Importers/SH3 PS3 Install")]
    public class SH3PS3InstallImporter : SourceHandler
    {
